export default function NavBar({ appName }) {
  ...
  return (
    <nav className="bg-white px-3.5 py-4">
      <div className="container flex flex-wrap items-center justify-between">
        ...
        <div className="flex md:order-2">
          ...
          <div className="relative hidden md:block">
            ...
            <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-slate-900 border border-slate-400 rounded-md bg-slate-50 focus:ring-blue-400 focus:border-blue-400" placeholder="Search..." />
          </div>
        ...
        <div id="navbar-menu" className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
          <ul className="flex flex-col p-4 mt-4 border border-slate-100 rounded-md bg-slate-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-white bg-blue-600 rounded md:bg-transparent md:text-blue-600 md:p-0 dark:text-white" aria-current="page">Home</a>
            </li>
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-slate-700 rounded hover:bg-slate-100 md:hover:bg-transparent md:hover:text-blue-600 md:p-0">About</a>
            </li>
            <li>
              <a href="/login" className="block py-2 pl-3 pr-4 text-slate-700 rounded hover:bg-slate-100 md:hover:bg-transparent md:hover:text-blue-600 md:p-0">Login</a>
            </li>
          </ul>
        </div>
      </div>
