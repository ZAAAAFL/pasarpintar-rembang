        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <th scope="row" className="py-4 px-6 font-medium text-sm text-gray-900 whitespace-nowrap dark:text-white">
                <a href="mailto:ardianto@gmail.com">ardianto@gmail.com</a> <br></br>
                <a href="tel:+628888901970">+62 888-8901-970</a>
              </th>
              <td className="py-4 px-6">
                <a href="" className="bg-blue-500 hover:bg-blue-600 text-white p-2 mx-2 rounded-md">Detail</a>
